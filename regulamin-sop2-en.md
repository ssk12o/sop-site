...
- The laboratory consists of four classes denoted as Lab1, Lab2, Lab3, Lab4. The laboratory classes take place according to the schedule provided on the course website. The course website also includes preparation materials for classes.
...
There are four laboratory classes during the semester, covering 4 topics, denoted as Lab1, Lab2, Lab3 and Lab4 on the course website.
...
- During entry tests one **cannot** use any aids besides one's own knowledge.  Communication with other students is forbidden.
